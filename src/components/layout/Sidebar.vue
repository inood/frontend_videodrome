...
import { HomeIcon, FilmIcon, VideoCameraIcon, MagnifyingGlassIcon } from '@heroicons/vue/24/outline'
...
<template>
<nav class="block flex-1 bg-movie-black-200">

  <div class="relative flex flex-row p-4 space-x-3">
    <router-link
